      ...
      <div className="container">
        ...
        <div className="grid gap-x-32 gap-y-20 lg:grid-cols-3 md:grid-cols-2 my-14">
          {features.map((feature, i) => (
            <div key={i} className="flex flex-col gap-[17px]">
              {/* <div className="bg-accent mb-5 flex size-16 items-center justify-center rounded-full">
                {feature.icon}
              </div> */}
              <h3 className="mb-2 text-2xl font-semibold text-center">{feature.heading}</h3>
              <p className="text-muted-foreground text-center text-[17px]">{feature.description}</p>
            </div>
          ))}
        </div>
